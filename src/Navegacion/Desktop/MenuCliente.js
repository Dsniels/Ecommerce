    ...
    <Box>
      ...
      <ActionMenu renderAnchor={null} >
        <ActionMenu.Button style={{ fontSize: 16, color: 'white', paddingLeft: 10, textAlign: 'center', display: 'flex', backgroundColor: 'transparent' }} variant="invisible">
          <Avatar size={50} className={classes.avatarPerfilAppBar} src={sesionUsuario ? (sesionUsuario.autenticado === true ? sesionUsuario.usuario.image : "https://avatars.githubusercontent.com/u/92997159?v=4" ) : "https://avatars.githubusercontent.com/u/92997159?v=4"} />
          { sesionUsuario  ? (sesionUsuario.autenticado === true ? sesionUsuario.usuario.name + ' ' + sesionUsuario.usuario.lastname : "usuario") : "usuario" }
        </ActionMenu.Button>
