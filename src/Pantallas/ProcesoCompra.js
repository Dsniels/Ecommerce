...
const ProcesoCompra = () => {
    ...
    return(
      <PageLayout>
        <PageLayout.Content>
            <Timeline style={{display:'flex', justifyContent:'center',marginLeft:30,color:'white'}}>
        <Timeline.Item>
            <Timeline.Badge><Octicon icon={PaperAirplaneIcon}></Octicon></Timeline.Badge>
            <Timeline.Body >
        ...
        <PageLayout.Pane sx={{backgroundColor:'#32383f', borderRadius:20}} width='large'>
                <Grid  fullWidth >
                    <Grid.Column style={{ justifyContent:'center', display:'flex',margin:25, color:'white'}} start={2} span={5} >
